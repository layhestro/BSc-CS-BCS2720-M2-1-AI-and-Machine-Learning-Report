...
\textbf{Tree-Based Ensembles:} Random Forest and Extra Trees Regressors were among the top performers, demonstrating the robustness of ensemble methods for non-linear data.
...
\textbf{K-Nearest Neighbors (KNN):} Surprisingly, the KNN Regressor emerged as the most effective model for PPO, achieving the lowest MAE of 57.54 MB and an $R^2$ of 0.99.

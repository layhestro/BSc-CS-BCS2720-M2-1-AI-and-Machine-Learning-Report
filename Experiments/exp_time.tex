...
\begin{itemize}
    ...
    \item \textbf{Features}: 18 predictors (4 categorical, 14 numeric)
...
\begin{itemize}
    ...
    \item Documented software versions (Python 3.10, scikit-learn 1.3+)
...
All experiments were executed on Google Colab Pro with consistent computational resources (CPU-based training, no GPU required for tabular data).
...
We implement stratified 5-fold cross-validation. The stratification divides training durations into quintiles, ensuring each fold contains a balanced mix of short, medium, and long training runs.
